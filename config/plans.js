...
const PLANS = {
  free: {
    ...
    monthlyRequests: 40,
    allowImages: true,
    defaultModel: "gpt-5.0-nano",
    allowedModels: ["gpt-5.0-nano", "gpt-5.0-mini"],
    fallbackModel: "gpt-5.0-nano",
    modelTokenMonthly: {
      "gpt-5.0-nano": 50000,
      "gpt-5.0-mini": 8000,
    },
  ...
  basic: {
    ...
    allowedModels: ["gpt-5.0-nano", "gpt-5.0-mini", "gpt-5.4-nano"],
    fallbackModel: "gpt-5.0-nano",
    modelTokenMonthly: {
      "gpt-5.0-nano": 400000,
      "gpt-5.0-mini": 200000,
  ...
  unlimited: {
    ...
    fallbackModel: "gpt-5.0-nano",
    modelTokenMonthly: {
      "gpt-5.0-nano": 5000000,
      "gpt-5.0-mini": 1000000,
